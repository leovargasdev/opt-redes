...
public class DistribuicaoRandomica extends Random {
	
    public DistribuicaoRandomica() {
        super();
    }
    
    public DistribuicaoRandomica(long seed) {
        super(seed);
    }
    
    
    public DistribuicaoRandomica(int seq_num, int seed_num) {
    ...
    public double nextExponential(double b) {
        ...
        double result;
        randx = nextDouble();
        System.out.println("b: "+b+" randx:"+randx);
