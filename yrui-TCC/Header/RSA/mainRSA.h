...
void verificaEnalecesRepetidos(int *caminhoPrincipal, int *caminhoSecundario) {
	...
	//Lê os dois caminhos e faz os pares de vertices que compoem o enlace
	for (i = 0; i < quantidadeVertices; i++) {
